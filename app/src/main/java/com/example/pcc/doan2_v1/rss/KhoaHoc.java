...
public class KhoaHoc extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Intent intent=new Intent(KhoaHoc.this,NewsDetailActivity.class);
    ...
    class ReadRSS extends AsyncTask<String, Void, ArrayList<NewsModel>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog=new ProgressDialog(KhoaHoc.this);
        ...
        protected void onPostExecute(ArrayList<NewsModel> newsModels) {
            ...
            dialog.dismiss();
            adapter=new NewsAdapter(KhoaHoc.this,0,newsModels,getLayoutInflater());
